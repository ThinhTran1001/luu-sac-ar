...
const collectionData = {
  vases: {
    ...
    images: [
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512400/CSE01687_xatqxf.jpg', name: 'Bình Hoa CDT 01' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512397/CSE01690_bwd1fb.jpg', name: 'Bình Hoa CDT 02' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512397/CSE01691_d36ryd.jpg', name: 'Bình Hoa CDT 03' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512398/CSE01692_tydzqs.jpg', name: 'Bình Hoa CDT 04' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512398/CSE01693_e2oorm.jpg', name: 'Bình Hoa CDT 05' },
    ],
  },
  tableware: {
    title: 'Đồ Ăn',
    ...
    images: [
      ...
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512401/CSE01711_dvxgiu.jpg', name: 'Bộ Đồ Ăn CDT 04' },
    ],
  },
  decor: {
    title: 'Trang Trí',
    ...
    images: [
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512401/CSE01714_okk3td.jpg', name: 'Tác Phẩm Nghệ Thuật 01' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512397/CSE01715_xj9zdw.jpg', name: 'Tác Phẩm Nghệ Thuật 02' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512402/CSE01718_pgeeot.jpg', name: 'Tác Phẩm Nghệ Thuật 03' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512400/CSE01725_irc4xn.jpg', name: 'Tác Phẩm Nghệ Thuật 04' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512403/CSE01727_itd8lk.jpg', name: 'Tác Phẩm Nghệ Thuật 05' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512403/CSE01729_g8biq7.jpg', name: 'Tác Phẩm Nghệ Thuật 06' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512398/CSE01731_gmo3vx.jpg', name: 'Tác Phẩm Nghệ Thuật 07' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512403/CSE01735_e0v8s9.jpg', name: 'Tác Phẩm Nghệ Thuật 08' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512403/CSE01737_veqax4.jpg', name: 'Tác Phẩm Nghệ Thuật 09' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512399/CSE01738_hkwm2v.jpg', name: 'Tác Phẩm Nghệ Thuật 10' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512404/CSE01740_kzix0d.jpg', name: 'Tác Phẩm Nghệ Thuật 11' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512397/CSE01741_nqmkk5.jpg', name: 'Tác Phẩm Nghệ Thuật 12' },
      { src: 'https://res.cloudinary.com/dnm1hfesq/image/upload/v1773512403/CSE01742_i8kflq.jpg', name: 'Tác Phẩm Nghệ Thuật 13' },
